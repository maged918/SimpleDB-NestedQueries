...
public class Parser {
	...
	public Parser(String s) {
		lex = new Lexer(s);
		System.out.println("Created new Parser");
	}
	...
	//Copied code updates starting here.
	...
	/*
	 * public Term term() { Expression lhs = expression(); lex.eatDelim('=');
	 * Expression rhs = expression(); return new Term(lhs, rhs); }
	 */
